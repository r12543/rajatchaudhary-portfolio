      ...
      <section id="about">
        <div className="row">
          ...
          <div className="nine columns main-col">
            <h2>About Me</h2>
            <p>Skilled in Node.js, Python, Big Data technologies (Kafka, Spark, Airflow), Backend Development 
              with Databases (MySQL, PostgreSQL, MongoDB, ArangoDB, ElasticSearch), Machine Learning. Experience 
            ...
            <div className="row">
              ...
              <div className="columns download">
                <p>
                  <a href="https://drive.google.com/file/d/1TGcNqfVEFbzoj5EUZS340R6o83fKJNO8/view" className="button" target="_blank"><i className="fa fa-download" />Download Resume</a>
                </p>
              </div>
            </div> {/* end row */}
          </div> {/* end .main-col */}
